...
class DescendantSelector:
    ...
    def __repr__(self):
        return "DescendantSelector(ancestor={}, descendant={}, priority={})".format(
...
class DrawText:
    ...
    def __repr__(self):
        return "DrawText(top={} left={} bottom={} text={} font={} color={})".format(
            self.top, self.left, self.bottom, self.text, self.font, self.color
        )
...
DEFAULT_STYLE_SHEET = CSSParser(
    open(os.path.join(os.path.dirname(__file__), "browser6.css")).read()
).parse()
